...
<?php $result = mysqli_query($mysqli,"SELECT * FROM customer"); ?>
    	...
    	<tr>
    		...
    		<td>
     			<a href="customerDelete.php?delete=<?php echo $row['Cust_Id']; ?>" onClick="del(this);" title="Delete" ><input type="image" src="images/icn_trash.png" title="Trash">  </a></td>
    	</tr>
