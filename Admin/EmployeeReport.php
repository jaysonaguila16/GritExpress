...
$w=array(90,90,90,85,30,20,20,20,18,15,15,15,15);
	...
	{ //width
		$this->Cell(90,10,$eachResult["Employee_ID"],1,0,'C');
		$this->Cell(90,10,$eachResult["Employee_Name"],1,0,'C');
		$this->Cell(90,10,$eachResult["Username"],1,0,'C');
...
$pdf->AddPage('L','A4',0);
	...
	$pdf->Cell(276,11,'EMPLOYEE REPORTS',0,0,'L');
	$pdf->Ln();
